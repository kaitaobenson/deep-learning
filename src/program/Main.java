...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        DataAmountTest dataTester = new DataAmountTest(3, 61, 0, 10,784, 10, .01f, new LeakyReLu(), 3, 15, 100);
        dataTester.test();
        LayerAmountTest layerTester = new LayerAmountTest(3, 10, 2, 1, 784, 10, .01f, new LeakyReLu(), 15, 1, true, 100);
        layerTester.test();
